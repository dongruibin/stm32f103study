...
static void LcdWriteReg(U16 Data) {
  // ... TBD by user
	ILI9341_REG = Data;								//modify by fire
}
...
static void LcdWriteData(U16 Data) {
  // ... TBD by user
	ILI9341_RAM = Data;								//modify by fire
}
...
static void LcdWriteDataMultiple(U16 * pData, int NumItems) {
  while (NumItems--) {
    // ... TBD by user
	ILI9341_RAM = *pData++;						//modify by fire
  }
}
...
//注意野火9341使用的是Config.Orientation = GUI_MIRROR_Y|GUI_MIRROR_X;
 //Config.Orientation = GUI_SWAP_XY | GUI_MIRROR_Y;					    //modify by fire  横屏		
  ...
  GUIDRV_FlexColor_SetFunc(pDevice, &PortAPI, GUIDRV_FLEXCOLOR_F66708, GUIDRV_FLEXCOLOR_M16C0B16);		//modify by fire ԭGUIDRV_FLEXCOLOR_F66708//9
//注意野火9341使用的是GUIDRV_FLEXCOLOR_F66709   9325使用F66708
